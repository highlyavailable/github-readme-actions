...
| --- | --- | --- | --- | --- |
| [Run concurrent dev server starts as parallel subtests](https://github.com/temporalio/cli/pull/1026) | `temporalio/cli#1026` | [open] | 1 | 5h |
| [feat(inputs.directory_monitor): Allow to preserve timestamps when moving file](https://github.com/influxdata/telegraf/pull/18921) | `influxdata/telegraf#18921` | [open] | 14 | 7h |
| [gcp: migrate Pub/Sub input and output to the pubsub/v2 SDK](https://github.com/redpanda-data/connect/pull/4432) | `redpanda-data/connect#4432` | [open] | 4 | 14h |
